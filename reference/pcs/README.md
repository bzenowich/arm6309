# `reference/pcs/` — Pinball Construction Set, Atari 800, 1983
...
⭐ **This is a build input, not reading.** `video3/bench/mkpcs.py` parses these files to
...
[`../../video3/docs/pcs.md`](../../video3/docs/pcs.md).

## ⚠ Why this one IS tracked when `../68k/`'s are not

[`../68k/README.md`](../68k/README.md) records what this project learned on 2026-09-04,
