...
>   physical-memory decode and `machine.md` §2's rule is not optional for it. ⭐ Since
>   2026-09-08 `/IOPAGE` also silences the card above 2 MB, for nothing: the map is 32 MB
>   and `A21`–`A24` never leave the motherboard — `machine.md` §2.
