...
**[`docs/modplayer.md`](../../docs/modplayer.md) §8 build step 0's exit criterion.**
...
```
python3 tools/modcompare/mkprobe.py /tmp/probes     # generate the probes
python3 tools/modcompare/ladder.py  /tmp/probes 8   # A/B every one of them
python3 tools/modcompare/abcompare.py song.mod      # detail on one module
```
