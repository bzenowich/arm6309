/* The song image, loader and replayer — docs/modplayer.md.
 *
...
/* Card RAM map, docs/modplayer.md §4.2. The two zero bytes at 0 are the
...
typedef struct {
     ...
     * the null sample — docs/modplayer.md §3. */
 ...
 * reason to `err` (docs/modplayer.md §4.6 — reject loudly). */
...
typedef struct {
     ...
     * docs/graphics.md §19 item 1 owes a measurement for. */
    unsigned store_cc;
