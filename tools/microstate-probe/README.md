...
Answers the question that `docs/plan.md` §8 lists as the top risk: **does one bus cycle's
...
for code that did not exist. Phase 1 does not measure it, because `src/stub_core.c`
