...
sixteen files, vendored here at [`reference/pcs/`](../../reference/pcs/). It is four
...
from `desk` like `pinball`, `monster` and `scroll`.
...
arm6309/video3/bench/pcspal.py             the palette
arm6309/video3/bench/pcspak.py             PPAK.s — the scan converter, modelled
arm6309/video3/bench/pcsphys.py            RUN.s — the ball, modelled
arm6309/video3/bench/pcsobj.py             RUN.s — the part procs, modelled
arm6309/video3/bench/mkpcs.py              the generator, and the bench's table
arm6309/video3/bench/checkpcs.py           the gate
arm6309/video3/bench/run-pcs.sh            the bench
```

## 7. Verification — `sh video3/bench/run-pcs.sh`
