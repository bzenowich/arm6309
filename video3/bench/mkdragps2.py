...
"""mkdragps2.py - the figure-8 window drag, as a PS/2 script.
    ...
    python3 video3/bench/mkdragps2.py > video3/bench/scripts/drag.ps2
    SESSION=1 python3 video3/bench/mkdragps2.py     the whole demo session
...
HEAD = """# drag.ps2 - GENERATED by video3/bench/mkdragps2.py.  Do not edit: the
...
#
# ⭐ SCREEN COORDINATES, Y DOWN (software/demo/emu/ps2script.h).  Time zero
...
# (desk.asm's header; docs/boot-and-desktop.md item 7).
