...
# mouse script for the host emulator (software/emu/ps2script.h).
#
#   sh software/emu/test/run-ps2script.sh        (from anywhere)
...
# (hardware/io/ps2/docs/history.md §11.5; software/desk/bench/run-v3desk.sh is what does).
...
cd "$(dirname "$0")/../../.."
ROOT=$(pwd)
OUT=${OUT:-$(cd "$_here/.." && pwd)/build/ps2script}
T=software/emu/test
S=$T/scripts
