...
"""mkmonster.py [CMDSDIR] - the `monster` scene's art, as lwasm source and JSON.
    ...
    python3 software/monster/bench/mkmonster.py ../nitros9/level2/arm6309/cmds
...
and, in hardware/video3/bench/:
    ...
    monster.json     ⭐ THE SAME DATA, for software/monster/bench/checkv3mon.py, which
...
═══ THE GEOMETRY, which hardware/video3/bench/README.md's monster section explains ═══
...
def main():
    ...
    bar = "*" * 68
    top = bar + "\n* %s - generated by software/monster/bench/mkmonster.py; do not edit by hand\n" + bar + "\n"
