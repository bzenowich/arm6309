...
"""mkstardew.py [CMDSDIR] - the `stardew` farm's art, palette and day cycle.
    ...
    python3 software/stardew/bench/mkstardew.py ../nitros9/level2/arm6309/cmds
...
(software/stardew/docs/stardew.md §0).  So the palette's split IS the specification:
...
entry, so setting it to zero costs nothing and changes no code.
    ...
    python3 software/stardew/bench/mkstardew.py --tint-test     # ~40 s; prints the table
"""
import base64
import hashlib
import json
...
def main():
    ...
    bar = "*" * 68
    top = bar + "\n* %s - generated by software/stardew/bench/mkstardew.py; do not edit by hand\n" + bar + "\n"
    if out:
