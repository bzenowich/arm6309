...
#
#   sh software/demo/bench/run-calib.sh [seconds]      (OUT=dir overrides)
#
...
"$V/obj_demo/demo_tb" +out="$OUT" +secs="$SECS" +rom="$ROOT/software/demo/$B/calib.hex" > "$OUT/demo.log" 2>&1 || true
