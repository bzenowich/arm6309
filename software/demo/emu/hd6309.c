 ...
 *   TFM          $1138-$113B   all four forms, cpu/docs/plan.md §4.3.1 semantics
...
static int tfm_run(cpu6809 *c, int64_t base, int n, int form, uint16_t opc_pc)
{
    ...
    /* ⭐ cpu/docs/plan.md §4.3.1 - DECIDED 2026-09-21.  The byte in flight is
     ...
     * anywhere checks it.  docs/6309.md §5.1.5. */
