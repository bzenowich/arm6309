...
"""Write the show: the script, its assets, and the model's pictures.
    ...
    python3 software/demo/tools/mkshow.py BUILD
...
B = sys.argv[1] if len(sys.argv) > 1 else os.path.join(os.path.dirname(__file__), "..", "build")
...
def main():
    ...
    inc = ["* GENERATED by software/demo/tools/mkshow.py - do not edit",
