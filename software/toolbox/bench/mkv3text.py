...
ROM toolbox text call.  `hardware/video3/bench/README.md` says so ("⛔ Does not answer -
...
# copied here by the engine. software/toolbox/docs/proportional-font.md §4 and keyed-copy.md
...
def sk_run(n):
    """⭐ THE STRIKE, TIMED - software/toolbox/docs/proportional-font.md §4.  N calls of the
...
def strike_run():
    """⛔ THE CORRECTNESS GATE for the glyph strike (software/toolbox/docs/proportional-font.md
