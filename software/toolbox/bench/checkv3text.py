...
def main(out):
    ...
    # ⭐⭐ THE NUMBER THE STRIKE EXISTS FOR - software/toolbox/docs/proportional-font.md §4.
...
if __name__ == "__main__":
    main(sys.argv[1] if len(sys.argv) > 1 else os.path.join(os.path.dirname(os.path.abspath(__file__)), "..", "build", "v3text"))
