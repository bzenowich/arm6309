...
*
* It is the program hardware/gal/verilog/v3machine_tb.sv runs on the real
...
* board of video3/docs/plan.md 13.1) in the slot.  Nothing here runs against a
...
*
* Assembled by A09 (software/tools/fetch-a09.sh); sh software/v3boot/mkv3rom.sh
