...
"""mklegs.py - a path turned into an fcb table of steps.
    ...
    python3 software/archive/nitros9-video/mklegs.py 186 194 175 195 emit   v3drag's figure-8
    python3 software/archive/nitros9-video/mklegs.py circle 25 56 emit      v3grab's circle
...
def emit_circle():
    ...
    print("* software/archive/nitros9-video/mklegs.py circle %d %d emit." % (R, n))
    print("*")
...
def main():
    ...
    print("* curve sampled %d times, from the window's home at (%d, %d) and back."
          % (N, HOME[0], HOME[1]))
    print("* %d steps, %d of them diagonal.  Generated by software/archive/nitros9-video/mklegs.py."
          % (n, diag))
    print("*")
