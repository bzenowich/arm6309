# `software/desk/video/` — NitrOS-9 on the virtual machine, as a video
...
⚠ **This is the emulator (`software/emu/`), not the RTL machine.** The video console has
not run on `machine_tb` (`../docs/video-console.md`). The video is **silent**: there is no
NitrOS-9 audio driver yet (`software/nitros9/docs/nitros9-av-plan.md` phase P4).
