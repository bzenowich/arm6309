...
The brief (hardware/video3/docs/demo-report.md): boot in 80 x 60 character mode, an
...
LINES = [
    ...
    # ⚠ and it is SKIPPED when software/paint/reference/we-tortuga.ans is not there: it is not
