...
"""mkpinball.py [CMDSDIR] - the `pinball` scene's ACTORS and its collision data.
    ...
    python3 software/archive/pinball/mkpinball.py ../nitros9/level2/arm6309/cmds
...
What it does emit is everything the picture is NOT:
    ...
    pinball.json     ⭐ THE SAME DATA, for software/archive/pinball/checkv3pin.py, which
...
def main():
    ...
    rule = "*" * 68
    top = rule + "\n* %s - generated by software/archive/pinball/mkpinball.py; do not edit by hand\n" + rule + "\n"
