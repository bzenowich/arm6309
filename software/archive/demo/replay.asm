...
*
* hardware/audio/docs/modplayer.md is the specification and hardware/audio/refplayer/mod_replay.c
...
* a 6809E (hardware/cpu/sim/mc6809), so nothing here uses a 6309 instruction.
...
*------------------------------------------------------------- the card -------
* audio.md 9.2, as hardware/audio/refplayer/card.h numbers them.
R_AIDX    EQU     $0
R_ADATA   EQU     $1
R_ADMACON EQU     $2
R_AINTENA EQU     $3
