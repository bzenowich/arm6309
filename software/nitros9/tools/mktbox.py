...
def widths_fcb(bold=True):
    ...
    is desktop (docs/boot-and-desktop.md §3.7).  The same pattern v3drag uses
    for mklegs.py's table: generated, pasted, and asserted by a bench so the
    copy cannot drift from the ROM's."""
    w = glyph_widths(bold)
    out = ["* GENERATED by `python3 software/nitros9/tools/mktbox.py --widths`.",
           "* ⚠ Do not hand-edit: video3/bench/checkmove.py recomputes these from",
