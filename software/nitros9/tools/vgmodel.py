...
docs/nitros9-av-plan.md phase P2 is CoArm's bitmap screens, windows, text,
...
def poly_spans(left, right):
    """software/demo/tools/show.py's polygon rule (Model.spans): (y, xl, xr),
...
def raster_colours(r, ph):
    """software/demo/tools/show.py's raster_colours, the same arithmetic."""
    cols = [r["base"]] * r["n"]
    for bar in range(3):
