...
# hardware/audio/sim/oracle/fetch-paula.sh states, applied to a tool instead
# of a model.
#
...
# HD6309 instruction set as well as the 6809's, which is the CPU hardware/cpu/README.md
...
DEST="${A09_DIR:-$(cd "$_here/../.." && pwd)/.tools/a09}"
REV="${A09_REV:-master}"
