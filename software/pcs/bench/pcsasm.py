...
`software/pcs/reference/pcs-source/` holds Pinball Construction Set (Atari 800, 1983) under the MIT
...
PCSDIR = os.path.join(ROOT, 'software', 'pcs', 'reference', 'pcs-source')
...
def blob(name):
    """A binary file from software/pcs/reference/pcs-source/ (BITMAPS.OBJ)."""
