...
It exists to be the gate.  `software/pcs/docs/pcs.md` 1 explains the decision the
...
Sources: `software/pcs/reference/pcs-source/PPAK.s` (the scan converter and its divide) and
`software/pcs/reference/pcs-source/RUN.s` (the ball).
"""
