...
> halving paid for a 512 KB system-RAM bank on the motherboard; `hardware/mainboard/docs/ram.md` §6
...
jumper (`machine.md` §5 item 7, `hardware/mainboard/docs/ram.md` §5.2).
...
`hardware/tools/place/parts.ts` to video 27 (its seven SRAMs became four, `graphics.md`
...
`hardware/mainboard/docs/ram.md` cite it for.
