...
module mainboard_tb;
  ...
  initial begin
    ...
    $display("");
    $display("Writing a block register - hardware/mainboard/docs/ram.md 4.3's two windows");
    $display("");
    ...
    // feature; tools/lib/parts.ts's SIMM30 shows pins 24 and 29 as NC. So the size
