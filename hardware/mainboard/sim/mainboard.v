...
// hardware/mainboard/board/mainboard.circuit.tsx, which is the netlist of record.
...
module mainboard #(
  ...
  // feature, and tools/lib/parts.ts's SIMM30 shows pins 24 and 29 as NC - so the
