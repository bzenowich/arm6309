...
export const mmuDesign: Design = {
   ...
   * which is what the pin budget in tools/gal/README.md spends to make this fit. */
  inputs: [
  ...
  cells: [
     ...
     * and tools/gal/README.md does not say so. As written in mmu.pld it is
     *
     *     MAPOE = !PAGE # BLK & RW & E
     *
     ...
     * tools/gal/README.md's pin budget had two rows: "6 outputs, 16 available
