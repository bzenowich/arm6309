/* U10 - the SIMM controller. hardware/mainboard/docs/ram.md 6.3, 6.6.
 *
...
export const u10Design: Design = {
  ...
  cells: [
     ...
     * contention tools/gal/README.md argues about for the system RAM's /OE. */
    {
     ...
     * low, the distinction mmu.pld's pin 23 had to learn (tools/gal/README.md
