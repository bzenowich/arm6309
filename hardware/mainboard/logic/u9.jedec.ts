/* U9 - the physical space decode. hardware/mainboard/docs/ram.md 6.3 and 6.7.
 *
...
export const u9Design: Design = {
  ...
  cells: [
     ...
     * move tools/gal/README.md argues for the system RAM's /OE, for the same reason:
     ...
     * had to learn the hard way (tools/gal/README.md finding 6). U10 is unfitted and
