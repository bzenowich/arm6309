 ...
 * machine's video card and `video/` was archived (`archive/README.md`,
 * `docs/history.md`). Twelve designs went with it - `hgen`, `vgen`, `vdec`,
 * `hadr`, `vadr`, `arb`, `wcol`, `wrow`, `seqph`, `seqctl`, `vlen` and `rfa`.
 *
 * ⚠ THEIR SOURCES ARE STILL HERE, in `gal/*.jedec.ts`, and that is deliberate:
 ...
 * retargeted yet, not a part of the machine. See `archive/README.md`.
 */
