...
export const CARDS: Record<string, CardSpec> = {
   ...
   * tools/lib/windows.ts because two cards cannot.
   *
  ...
  audio: {
    title: "Audio", length: 180, ics: 35, source: "hardware/audio/docs/audio.md 10",
  ...
  net: {
    title: "Net", length: 120, ics: 12, source: "hardware/net/docs/net.md 9",
  ...
  storage: {
     ...
     * 681 KiB/s -> 537. storage/logic/census.ts is the derivation, and it also
     * says why the buffered card was never the 14 this table claimed: its
     * logic is four GAL22V10s, not two. */
    title: "Storage", length: 120, ics: 8, source: "hardware/storage/docs/sdcard.md 8",
  ...
  io: {
    title: "I/O", length: 120, ics: 14, source: "hardware/io/ps2/docs/ps2.md 9 + hardware/io/serial/docs/serial.md 9",
 ...
 * there owns a window in tools/lib/windows.ts, and two cards cannot own $FF60.
 ...
 * day (docs/history.md, hardware/archive/README.md). It is the machine's specified
 * video card no longer: 33 ICs, three fitted ATF1508AS and a drawn board in
 * archive/video/board/video.circuit.tsx, kept placed and counted because it is a complete
 * design and because `machine_tb` still builds it. Its documents are in
 * hardware/archive/video/.
 *
 * ⚠ `video2` (the microcoded ANSI card, hardware/archive/video2/plan.md) and the
...
export const ALTERNATES: Record<string, CardSpec> = {
  video: {
    title: "Video", length: 240, ics: 33, source: "hardware/archive/video/docs/graphics.md 14.1",
