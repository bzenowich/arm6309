 ...
 *
 * hardware/mainboard/docs/ram.md §6.5: 19 ICs and four 30-pin SIMM sockets. There is no SRAM
...
export const MB_PARTS: [number, number, number, number, string, Kind, boolean][] = [
   ...
   * part and not the other (ram.md §4.1 Layout A, mainboard/logic/u9.pld). */
