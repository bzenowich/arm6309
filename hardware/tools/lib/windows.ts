 ...
 * which is taken. The check in tools/lib/cards.check.ts is what stops two proposals
 * from quietly overlapping.
 *
 * hardware/net/docs/net.md 5.1 took the last of the original 64 bytes - storage handed
 ...
 * than the 64-byte version it replaces (mainboard/logic/clkdec.pld).
 *
 ...
 * card decodes A0-A6. archive/video/logic/vctrl.pld is the one card decode that exists here
...
export const WINDOWS: Window[] = [
  ...
  { card: "io",      base: 0xff30, size: 16, status: "proposed", source: "hardware/io/ps2/docs/ps2.md 3.2 + hardware/io/serial/docs/serial.md 7.1" },
  { card: "audio",   base: 0xff40, size: 16, status: "proposed", source: "hardware/audio/docs/audio.md 9.1" },
  { card: "(free)",  base: 0xff50, size: 8,  status: "free",     source: "vacated by the I/O card 2026-09-09" },
  { card: "storage", base: 0xff58, size: 4,  status: "proposed", source: "hardware/storage/docs/sdcard.md 6.1" },
  { card: "net",     base: 0xff5c, size: 4,  status: "proposed", source: "hardware/net/docs/net.md 5.1" },
  ...
  { card: "video3",  base: 0xff60, size: 32, status: "taken",    source: "hardware/video3/docs/plan.md 10" },
]
...
export const MMU_WINDOWS: Window[] = [
  ...
  { card: "mmu-high", base: 0xff90, size: 16, status: "taken", source: "hardware/mainboard/docs/ram.md 4.3 - block registers, physical A24..A21 + 3.3's flags" },
  { card: "mmu-low",  base: 0xffa0, size: 16, status: "taken", source: "hardware/mainboard/docs/ram.md 4.3 - block registers, physical A20..A13" },
