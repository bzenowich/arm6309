 ...
 * hardware/archive/video/docs/graphics.md 17. Nothing is invented here; the only decisions this
 ...
 * already stored and read back (tools/gal/README.md), so A20 costs a trace out of
 * a latch that was carrying it anyway.
 *
 * THERE IS NO SPARE PIN NOW. hardware/net/docs/net.md 13.1 wanted two of them for a
