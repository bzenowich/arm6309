...
#
# Usage: fit1508.sh audio/logic/audio.pld [device]     (from hardware/)
...
# the fit lands beside its design: <card>/logic/foo.pld -> <card>/logic/cpld/
OUT=$(cd "$(dirname "$PLD")" && pwd)/cpld
mkdir -p "$OUT"
