 ...
 *
 * This is the "fitter" tools/gal/README.md's open item 1 says the design has never
...
export const toJedec = (d: Design, a: Assembly): string => {
  const lines: string[] = []
  lines.push(`GAL-Assembler:  hardware/tools/gal/jedec, arm6309`)
 ...
 * This is the artefact tools/gal/README.md open item 1 actually wants. */
export const toReport = (d: Design, a: Assembly): string => {
  ...
  /* The pin budget tools/gal/README.md works out by hand: available inputs are the
