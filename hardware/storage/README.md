...
runs as part of `make -C hardware check`. `../hardware/gal/verilog/storage_card.v` is the board
...
the bootstrap — [`software/nitros9/docs/drivewire.md`](../../software/nitros9/docs/drivewire.md). **Step 1 is the silicon
