# `hardware/io/` — keyboard, mouse and serial
...
> `hardware/io/board/io.circuit.tsx`, **14 ICs on a 12 cm card**.
>
...
first one that can out-rate video's VBL (`hardware/net/docs/net.md` §3.4).
