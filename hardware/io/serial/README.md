# `hardware/io/serial/` — RS-232 serial
...
**Tier 1 is the card. Tier 2 is not built** — §13 item 7, and `software/nitros9/docs/drivewire.md` §3 is
...
missing from `hardware/io/board/io.circuit.tsx` entirely until the same pass, and it is on
