/* PS/2 keyboard and mouse - 11 ICs, io/ps2/docs/ps2.md 12.
 *
 * Eleven ICs of logic because no period chip decodes PS/2. Five packages are
 * shared and six are per-port; both ports are identical, which is why the
 * per-port block is a component here rather than twelve hand-wired parts.
 *
 * The card is a third source on the shared /IRQ (ps2.md 3.1) and is polled
 * second, between video and serial (machine.md 4.1).
 */
...
export default () => (
  <Card name="arm6309-ps2" ioBase={0xff50} ioSize={4} icBudget={11}>
