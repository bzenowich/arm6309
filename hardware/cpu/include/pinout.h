 ...
 * Mirrors hardware/cpu/docs/plan.md §3.2. Change both together.
 *
 ...
 * (History: hardware/cpu/docs/history.md, design review Cpu-C1.)
 *
 ...
 * See hardware/cpu/docs/plan.md §7, Phase 6. The alternative — a pulldown on PB8 —
 ...
 * Wire this part straight to the socket and it dies. See hardware/cpu/docs/plan.md §3.5.
 *
