/* GPIO and TIM1 setup for the HD6309E pinout.  See hardware/cpu/include/pinout.h.
 *
 * Everything on the bus is set to VERY_HIGH output speed. The deadline is
 * t_AD = 110 ns = 18.7 core cycles at 170 MHz (hardware/cpu/docs/plan.md §3.3 — an
...
void gpio_init(void)
{
     ...
     * (see hardware/cpu/include/pinout.h). BA/BS are wired anyway for other 6809E hosts. */
