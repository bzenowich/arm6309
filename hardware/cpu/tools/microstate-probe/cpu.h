/* Register layout for the microstate cost probe.  hardware/cpu/docs/plan.md §3.3(d), §4.1.
 *
 ...
 * (hardware/cpu/include/pinout.h).  /HALT is PA12, so it arrives free in the same GPIOA
