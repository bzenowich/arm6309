#!/usr/bin/env python3
"""Write hardware/video3/bench/v3copy.asm and v3copy.json - the copy-engine exerciser.

hardware/video3/docs/plan.md §6.  Bitmap mode makes VRAM observable: one byte is one
