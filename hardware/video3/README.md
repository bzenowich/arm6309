# `hardware/video3/` — a console-first video card
...
⛔ **No utilisation figure from `video/`'s fit applies to video3.** Mechanism and timing
arithmetic transfer; cell counts, fan-in and "which part has room" do not — plan §14
item 4.
...
refuse. ⚠ That claim is §14 item 1 and its timing is not yet analysed.
