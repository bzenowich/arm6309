...
//
// software/boot/v3boot/v3boot.asm, assembled by A09 (software/boot/v3boot/mkv3rom.sh),
...
// lists tools/gal/jedec/cupl.ts compiles for the fitter, plus the board of
// hardware/video3/docs/plan.md §13.1. ⚠ U3 and U6 are NOT generated: they are the
// hand-written mainboard/sim/mmu.v and mainboard/sim/clkdec.v.
//
...
module v3machine_tb;
   ...
   * software/boot/v3boot/v3boot.asm never reads $FF59, so 0 here is a socket this
  ...
  initial begin
    m.mb.load_rom_file("../../../software/boot/build/v3boot.hex");
