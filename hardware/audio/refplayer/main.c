/* arm6309 reference module player — hardware/audio/docs/modplayer.md §8 build step 0.
 *
 ...
 * hardware/audio/docs/audio.md §16 item 13 race the loop-pointer write the way it does on real
...
int main(int argc, char **argv)
{
     ...
     *
     * ⚠ WHY THIS EXISTS AND WHAT IT IS NOT. hardware/audio/sim/modplay_tb.sv
     ...
     * the card fetched from unwritten RAM -- hardware/audio/docs/modplayer.md §4.6. It is
