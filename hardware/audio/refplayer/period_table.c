 ...
 *
 * hardware/audio/docs/modplayer.md §5.4 and §11 item 4: this table is COPIED, never computed.
 ...
 * read as-is, which is why hardware/audio/docs/modplayer.md §3 says to copy the nibble and not
 * to sign-extend it.
 */
