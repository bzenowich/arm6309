/* The song image, loader and replayer — hardware/audio/docs/modplayer.md.
 *
...
/* Card RAM map, hardware/audio/docs/modplayer.md §4.2. The two zero bytes at 0 are the
...
typedef struct {
     ...
     * the null sample — hardware/audio/docs/modplayer.md §3. */
 ...
 * reason to `err` (hardware/audio/docs/modplayer.md §4.6 — reject loudly). */
...
typedef struct {
     ...
     * the one race hardware/audio/docs/modplayer.md §5.3 exists to rule out: with zero elapsed
     ...
     * hardware/archive/video/docs/graphics.md §19 item 1 owes a measurement for. */
    unsigned store_cc;
