...
**[`hardware/audio/docs/modplayer.md`](../../docs/modplayer.md) §8 build step 0's exit criterion.**
...
```
python3 hardware/audio/tools/modcompare/mkprobe.py /tmp/probes     # generate the probes
python3 hardware/audio/tools/modcompare/ladder.py  /tmp/probes 8   # A/B every one of them
python3 hardware/audio/tools/modcompare/abcompare.py song.mod      # detail on one module
```
