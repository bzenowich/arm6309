 ...
 *
 * hardware/audio/sim/modplay_tb.sv plays a module on audio_card.v - the real
 ...
 * hardware/audio/refplayer/render.c, which is a model of the card's ANALOGUE chain.
 *
 * ⛔ IT IS NOT hardware/audio/refplayer/card.c. Nothing in this tool models the state
