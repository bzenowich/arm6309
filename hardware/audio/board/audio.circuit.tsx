 ...
 * LRRL panning. 35 ICs, hardware/audio/docs/audio.md 10: U1 (audio) and U2 (aseq) are
 * both ATF1508AS PLCC-84 and both fitted (audio/logic/cpld/audio.fit, aseq.fit).
 *
 ...
 * the datapath pinout open, and tools/gal/pins.check.ts holds the pin senses that
...
export default () => (
  <Card name="arm6309-audio" ioBase={0xff40} ioSize={16} length={180} icBudget={35}>
    {/* OSC1 - not the backplane's 25.175 MHz. machine.md 1's one-master rule
      ...
      * osc" and tools/place/parts.ts. It was drawn as a bare crystal with one leg
    ...
    {/* U1 - the host interface, the interrupt block, the timer and the free-
      * running counter (audio.md 10.1). hardware/audio/logic/cpld/audio.fit is the
    ...
    {/* J2 - 3.5 mm stereo, on the card's rear edge, added 2026-09-08.
      ...
      * backplane and tools/lib/slot.ts carries them at B32-B35 - and NOTHING in the
