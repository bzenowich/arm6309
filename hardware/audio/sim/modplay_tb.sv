...
//
//   sh audio/sim/run-modplay.sh hardware/audio/build/mod/00_notes.mod
//
...
//     hardware/audio/docs/modplayer.md §5's tick engine - and it arrives here as a
//     recorded trace from hardware/audio/refplayer, which is the reference the 6309 port
...
//     and hardware/audio/tools/dacwav renders that through hardware/audio/refplayer/render.c,
...
module modplay_tb;
  ...
  /* ---- the trace ------------------------------------------------------- */
  // hardware/audio/refplayer's format: "%06lu %-7s %02X" - tick, register name, byte.
