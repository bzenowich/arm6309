...
```sh
sh audio/sim/oracle/run-oracle.sh        # from hardware/
```
...
([`audio.md`](../../docs/audio.md) §16 item 36).

⚠ **And a green `modcompare` says nothing about it.** `hardware/audio/tools/modcompare/` A/Bs
`hardware/audio/refplayer/` — a **C model** of this card — against libopenmpt, and has agreed
