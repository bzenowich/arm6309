...
import { merge, toCupl, withActiveLow, type Merged } from "../../tools/gal/jedec/cupl"
...
const merged: Cell[] = [
   ...
   * hardware/audio/board/audio.circuit.tsx wires neither the address bus nor a
   ...
   * cards driving D0-D7 at once, silently. archive/video/logic/regfile.jedec.ts carries the
