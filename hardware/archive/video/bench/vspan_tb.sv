...
module vspan_tb;
  ...
  initial begin
     ...
     * bench's free-running E cannot do - machine_tb and software/archive/demo/ can.) */
    begin
      int bad_poll, runs;
      bad_poll = 0; runs = 0;
    ...
    /* ⭐ THE ARMED GO - software/nitros9/docs/nitros9-hardware-improvements.md H14, 2026-09-14.
     ...
     * software/emu/ assumes. WAIT, MOVE HSCROLL, END - armed in the blank -
