...
#
#   sh software/archive/demo/bench/run-vramrate.sh [seconds]     (OUT=dir overrides)
#
...
PY
cc -O2 -w -I"$ROOT/hardware/audio/refplayer" -o "$OUT/emu" emu/machine.c emu/cpu6809.c emu/hd6309.c "$ROOT/hardware/audio/refplayer/card.c"
