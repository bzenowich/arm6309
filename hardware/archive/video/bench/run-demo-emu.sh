...
#
#   sh software/emu/run-emu.sh [seconds]        OUT=dir overrides /tmp/arm6309-emu
#
...
ROOT=$(cd ../.. && pwd)
cc -O2 -w -I"$ROOT/hardware/audio/refplayer" -o "$OUT/tracewav" tools/tracewav.c \
   "$ROOT/hardware/audio/refplayer/card.c" "$ROOT/hardware/audio/refplayer/mod_load.c" "$ROOT/hardware/audio/refplayer/render.c" -lm
