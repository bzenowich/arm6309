...
#
# software/nitros9/docs/nitros9-av-plan.md phases P1 and P2 are closed by this: scripted clients'
...
MOVES=$(python3 software/archive/overworld/vgmodel.py --mouse)
...
# SS.MapWr, libvid and SS.Batch - judged against software/zelda/bench/mkgame.py's
...
python3 software/archive/overworld/checkvid.py "$OUT"
