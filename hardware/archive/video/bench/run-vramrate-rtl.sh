...
#
#   sh software/archive/demo/bench/run-vramrate-rtl.sh [seconds]    (~15 min at 7 s)
#
...
"$V/obj_demo/demo_tb" +out="$OUT" +secs="$SECS" +rom="$ROOT/software/archive/demo/$B/vramrate.hex" > "$OUT/demo.log" 2>&1 || true
