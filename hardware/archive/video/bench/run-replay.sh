#!/bin/sh
# The 6809 replayer against hardware/audio/refplayer, on the CPU alone - replay_tb.sv.
#
#   sh software/archive/demo/bench/run-replay.sh [seconds]
#
...
$V --top-module replay_tb -Mdir $B/obj_replay \
   "$ROOT/hardware/cpu/sim/mc6809/mc6809e.v" "$ROOT/hardware/cpu/sim/mc6809/mc6809i.v" \
