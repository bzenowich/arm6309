...
export const listDecode: Cell[] = [
   ...
   * (software/nitros9/docs/nitros9-hardware-improvements.md H14). WAIT n is line n only for a
...
export const paletteWrite: Cell[] = [
   ...
   * software/nitros9/docs/nitros9-hardware-improvements.md H7, graphics.md 13.1's response 3.
