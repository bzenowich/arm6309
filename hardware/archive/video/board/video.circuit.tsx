 ...
 * (hardware/archive/README.md, docs/history.md) and `video` is an ALTERNATE in
 * tools/place/parts.ts: placed, counted and owning no $FF window. This drawing is
 ...
 * hardware/archive/video/docs/graphics.md 14.
 *
 * Bus interface AND the analogue back end. graphics.md 18 steps 1-2 require
 * benching the dot path before layout; the CPLDs are fitted (<card>/logic/cpld/) and
 ...
 * drawn here. Their pin senses are held by tools/gal/pins.check.ts until they are.
 *
 ...
 * from archive/video/logic/vsup.pld and archive/video/logic/vctrl.pld.
 */
...
export default () => (
  <Card name="arm6309-video" ioBase={0xff60} ioSize={32} length={240} icBudget={33}>
    ...
    {/* J2 - the connector. HSYNC and VSYNC are separate TTL pins, so RGB has no
      ...
      * dedicated returns, kept away from 25.175 MHz on purpose (tools/lib/slot.ts).
