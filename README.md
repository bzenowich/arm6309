...
| [`audio/`](audio/) | 4-channel 8-bit PCM modelled on Paula. **57 ICs** — and whether that fits one card is open. Host reference model **builds and passes**. | **Specified; reference player validated against libopenmpt** | [`audio/README.md`](audio/README.md), [`audio/docs/audio.md`](audio/docs/audio.md) |
