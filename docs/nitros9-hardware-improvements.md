...
| **6** | **H15, hardware sprites** (H1 generalised) | the overworld's hero: 15 tiles the CPU composites, **14 updates a second** (2026-09-17: 4.4 before the software was rewritten — `video3/docs/demo-report.md` §10.3), and a 0.47–0.78 ms flip in a 1.56 ms blank | **≈ +8 or more**: a compare and a shape store per sprite, and a priority mux in the pixel path | the same timing objection, larger |
