...
```
        ...
        ...                       ; and the index is {TASK, block} - hence the
                                  ; order
...
| 5 V | **audio card** | **32** — `audio.md` §10.1 | **~340–500 mA** — `audio.md` §10. The upper figure is §7.1's headphone driver into a low-impedance load on both channels at once |
