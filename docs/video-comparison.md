...
| | **arm6309 card** | GIME | VIC-II |
|---|---|---|---|
| Packages | **41 ICs** (37 if the tri-state pixel bus closes) plus a 3-transistor analog drive stage — ~~40 (36)~~, ~~36 (32)~~ | **1 custom ASIC** (TCC1014, large DIP) | **1 custom ASIC** (40-pin DIP) |
